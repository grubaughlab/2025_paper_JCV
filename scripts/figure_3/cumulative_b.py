...
if not any(matrix.flatten()):
    ...
    ax.set_title("Lineage B: Mosquito Reward Proportions Over Time")
    ax.set_xlabel("Year")
    ...
    ax.set_ylim(0, 1)
    plt.tight_layout()
    plt.savefig("b_rewards_full.png", facecolor="white", bbox_inches="tight", dpi=600, transparent=False)
    plt.close()
    ...
    if filtered_years:
        ...
        # ax.legend(loc="upper left", fontsize=10, title="Reward category")
        # ax.set_title("Lineage B")
        # ax.set_xlabel("Year")
        # ax.set_ylabel("Markov Reward Proportion")
        ...
        ax.set_ylim(0, 1)
        plt.tight_layout()
        plt.savefig("b_rewards_since1997.png", facecolor="white", bbox_inches="tight", dpi=600, transparent=False)
        plt.close()
    else:
...
# save files as csvs
annual_df.to_csv("b_rewards_absolute_time.csv")
annual_prop.to_csv("b_rewards_proportions.csv")
...
summary_df.to_csv("b_rewards_summary.csv")
